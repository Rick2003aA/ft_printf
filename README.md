...
フォーマット文字の解析、可変長引数の処理、文字列操作、数値変換など、  
C 言語の低レイヤー構造を深く理解することを目的としています。
...
### ● ポインタの 16 進変換
`unsigned long long` にキャストして安全を確保。

### ● 戻り値のカウント漏れ
再帰内部で return する際に  
**出力文字数を必ず積み上げる必要がある**。→putcharで一括管理することにより、戻り値を簡単に管理することができた
